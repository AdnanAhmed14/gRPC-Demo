...
public final class StudentServiceGrpc {
  ...
  public static final String SERVICE_NAME = "student.poc.grpc.StudentService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<student.poc.grpc.StudentRequest,
      student.poc.grpc.StudentResponse> getAddStudentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addStudent",
      requestType = student.poc.grpc.StudentRequest.class,
      responseType = student.poc.grpc.StudentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<student.poc.grpc.StudentRequest,
      student.poc.grpc.StudentResponse> getAddStudentMethod() {
    io.grpc.MethodDescriptor<student.poc.grpc.StudentRequest, student.poc.grpc.StudentResponse> getAddStudentMethod;
      ...
      synchronized (StudentServiceGrpc.class) {
        if ((getAddStudentMethod = StudentServiceGrpc.getAddStudentMethod) == null) {
          StudentServiceGrpc.getAddStudentMethod = getAddStudentMethod =
              io.grpc.MethodDescriptor.<student.poc.grpc.StudentRequest, student.poc.grpc.StudentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "addStudent"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  student.poc.grpc.StudentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  student.poc.grpc.StudentResponse.getDefaultInstance()))
  ...
  public static abstract class StudentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addStudent(student.poc.grpc.StudentRequest request,
        io.grpc.stub.StreamObserver<student.poc.grpc.StudentResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                student.poc.grpc.StudentRequest,
                student.poc.grpc.StudentResponse>(
  ...
  public static final class StudentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<StudentServiceBlockingStub> {
    ...
    /**
     */
    public student.poc.grpc.StudentResponse addStudent(student.poc.grpc.StudentRequest request) {
  ...
  public static final class StudentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<StudentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<student.poc.grpc.StudentResponse> addStudent(
        student.poc.grpc.StudentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_STUDENT:
          serviceImpl.addStudent((student.poc.grpc.StudentRequest) request,
              (io.grpc.stub.StreamObserver<student.poc.grpc.StudentResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class StudentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return student.poc.grpc.StudentServiceOuterClass.getDescriptor();
    }
